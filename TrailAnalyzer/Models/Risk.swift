...
enum Risk: String, Identifiable, CaseIterable {
    ...
    var description: String {
        ...
        case .moderate:
            return "As with any hike, make sure you bring plenty of water, sunscreen, bug spray, and snacks. Plan for some breaks along the way to keep your energy up, and check your health and fitness apps to monitor your heart rate and energy levels. You go this!"
        case .easy:
